...
class EditWeightState extends State<EditWeightScreen> with VaildateMixin {
  var screenSize;
  ...
  Widget build(context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            titlePanel(screenSize, "Change Weight,",
                blocControl.signedIn ? blocControl.name : 'Visitor'),
            formTitlePanel(screenSize,
                "Type the weight you want to use in your account with us"),
