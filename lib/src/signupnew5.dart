...
class SignUpNew5 extends StatefulWidget {
  createState() {
    return SignUpNew5State();
  }
}

class SignUpNew5State extends State<SignUpNew5> with VaildateMixin {
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            inputPanel(screenSize, formKey, "What's your weight?"),
            skipNowPanel(screenSize, context, 'weight'),
            Positioned(
              bottom: keyboard == 0
              ...
              child: Container(
                ...
                //color: Colors.blue,
                child: nextButtonPanel(screenSize, formKey, context, 'weight'),
              ),
            ),
          ],
        ),
