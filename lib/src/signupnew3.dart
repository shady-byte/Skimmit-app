...
class SignUpNew3 extends StatefulWidget {
  createState() {
    return SignUpNew3State();
  }
}

class SignUpNew3State extends State<SignUpNew3> with VaildateMixin {
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            skipNowPanel(screenSize, context, 'age'),
            Positioned(
              bottom: keyboard == 0
              ...
              child: Container(
                ...
                //color: Colors.blue,
                child: nextButtonPanel(screenSize, formKey, context, 'age'),
              ),
            ),
          ],
        ),
